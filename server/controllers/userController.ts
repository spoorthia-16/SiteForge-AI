...
//Controller func to toggle project publish
export const togglePublish = async (req: Request, res:Response)=>{
    try {
        ...
        res.json({message: project.isPublished ? 'Project Unpublished':'Project published sucessfully'})
...
//Controller func to purchase credits
export const purchaseCredits = async (req: Request, res:Response)=>{
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            cancel_url: `${origin}/loading`,
            line_items:[ 
            {
                price_data: {
                    currency:'usd',
                    product_data:{
                        name: `SiteForgeAI - ${plan.credits} credits`
                    },
